...
sender_name = st.text_input("Please provide the name of the Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_name = st.text_input("Please provide the name of the receiver.")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
tx_amount = st.number_input("Please provide the amount of the Transaction.")
